...
- Implement some kind-of function that auto-adds points to the existing base mesh
- Make the function auto-add points in a loop and make the simulation run again and again, check for s-parameter impedance convergence as a stop-point for simulations.

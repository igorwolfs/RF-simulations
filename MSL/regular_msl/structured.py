...
pml_weight_fct = 'pow(x-' + str(MSL_dx-abs_length) + ',2)'
# pml_weigth_fct_arr = [pml_weight_fct, pml_weight_fct, pml_weight_fct]
materialList['fakepml'].SetMaterialWeight(kappa=pml_weight_fct, sigma=pml_weight_fct)
...
ax2.plot(freq*1e-6, imag(Z), 'b-', linewidth=2, label='$\Im\{Z\}$')

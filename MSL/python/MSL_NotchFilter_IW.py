...
'''
QUESTION:
Why are there 3 probes for the voltage, 2 for the current.
MY GUESS:
-> Is it maybe to have a distributed port, to have a better result for S-parameters than we would have with a lumped port?

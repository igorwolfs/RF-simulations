...
U = ReadUI( {'ut1','ut2','et'}, strcat(mfilename, '/'), freq ); % time domain/freq domain voltage
I = ReadUI( 'it1', strcat(mfilename, '/'), freq ); % time domain/freq domain current (half time step offset is corrected)
...
legend( 'real', 'imag' );
pdf_filepath_hf = strcat(mfilename, "/", mfilename, ".pdf");
print (hf1, pdf_filepath_hf, "-dpdf");
...
#! TODO: Try to make this PML absorbion layer work with any frequency, understand how it works
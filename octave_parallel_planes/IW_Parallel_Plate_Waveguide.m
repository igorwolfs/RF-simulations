...
WriteOpenEMS(strcat(save_folder,'/sinusoidal.xml'),FDTD,CSX);
...
### DEBUGGING
Use -vvv as flag in the run_openems-function to set the global verbose-level to 3 and see all debug information.
%}